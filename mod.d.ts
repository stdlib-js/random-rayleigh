...
interface RandomFunction extends PRNG {
	/**
	* Returns an ndarray containing pseudorandom numbers drawn from a Rayleigh distribution.
	*
	...
	*/
	<T extends typedndarray<number>>( shape: Shape, sigma: number | T, options?: Options ): RandomArray;

	/**
	* Fills an ndarray with pseudorandom numbers drawn from a Rayleigh distribution.
	*
	* @param sigma - scale parameter
	...
	* @returns output ndarray
	*/
	assign<T extends typedndarray<number>, U extends typedndarray<number>>( sigma: number | T, out: U ): U;
}
...
interface Random extends PRNG {
	...
	*/
	...
	/**
	* Returns a function for creating ndarrays containing pseudorandom numbers drawn from a Rayleigh distribution.
	*
	* @param options - function options
